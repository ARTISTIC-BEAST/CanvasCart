      ...
      <div className="about-container">
        <div className="about-main">
          ...
          <div className="about-info">
            <p>
            This is a full stack dynamic eCommerce project that fetches painting data from a museum's public API
        ...
        <div className="about-bottom">
          <a href="https://github.com/ARTISTIC-BEAST/CanvasCart" className="about-btn">GitHub</a>  
